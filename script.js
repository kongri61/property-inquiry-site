    ...
    if (districtSelect) {
        districtSelect.addEventListener('change', function() {
            ...
            const hasDetailData = [
                ...
                // 경기도 (일부 주요 지역만)
                '안양시 만안구', '안양시 동안구', '시흥시', '성남시 분당구', '성남시 수정구', '성남시 중원구', '수원시 권선구', '수원시 영통구', '수원시 장안구', '수원시 팔달구', '고양시 덕양구', '고양시 일산동구', '고양시 일산서구', '용인시 기흥구', '용인시 수지구', '용인시 처인구', '화성시', '평택시', '안산시 단원구', '안산시 상록구'
            ];
            ...
            const districtData = {
                ...
                '부천시': ['심곡동', '부천동', '중동', '신중동', '상동', '대산동', '소사동', '범박동', '성곡동', '오정동', '원종동', '원미동', '도당동', '약대동', '고강동', '작동', '괴안동', '삼정동', '여월동', '송내동', '역곡동', '춘의동', '신중동', '상동', '대산동', '소사동', '범박동', '성곡동', '오정동', '원종동', '원미동', '도당동', '약대동', '고강동', '작동', '괴안동', '삼정동', '여월동', '송내동', '역곡동', '춘의동'],
